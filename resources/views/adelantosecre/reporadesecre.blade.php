...
var formattedDate = currentDate.toISOString().slice(0, 10);
 ...
 const docDefinition = {
   ...
   content: [
     { text: 'Lista de Adelantos de las Secretarias', 
       //style: 'header'
      },
      {
 ...
 pdfMake.createPdf(docDefinition).download(
   "reporte_adelanto_de_secretarias-" + formattedDate + ".pdf"
 );
}
...
function obtenerDatosTabla() {
 ...
 var filas = [];
 var headers= [ 'fecha del adelanto', 'monto', 'estado', 'observacion','secretaria'];
 filas.push(headers);
 secretariareporte.forEach(function (adelantosecre) {
   var fila = [
    // profesor.id,
