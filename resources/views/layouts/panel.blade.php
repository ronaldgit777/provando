...
<body class="bg-gradient-info">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <img src="{{asset ('img/brand/telc.jpg')}}" class="navbar-brand-img " width="6%"  >   
        <a  class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block"  href="{{ url('/home') }}">PAGINA DE ÍNICIO</a>
