...
<script>
  ...
  var formattedDate = currentDate.toISOString().slice(0, 10);
      ...
      content: [
         ...
         },
        {
          table: {
            ...
            headers: ['Fecha de ingreso', 'ci', 'nombre', 'apellido paterno','apellido materno','celular','direccion','correo','estado','imagen','sueldo','role'],
    ...
    pdfMake.createPdf(docDefinition).download(
      "reporte_lista_de_profesores-" + formattedDate + ".pdf"
    );
  }
  ...
  function obtenerDatosTabla() {
    ...
    var filas = [];
    var headers= [ 'Fecha de ingreso', 'ci', 'nombre', 'apellido paterno','apellido materno','celular','direccion','correo','estado','imagen','sueldo','role'];
    filas.push(headers);
    profesorreporte.forEach(function (profesor) {
      var fila = [
       // profesor.id,
