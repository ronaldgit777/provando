...
@section('content')
  <div class="card shadow">
    <div class="card-header border-0">
      <div class="row align-items-center">
            <div class="col">
              <h3 class="mb-0">LISTA DE PROMEDIOS DE LOS ALUMNOS REPORTE -rol secre- <label > {{ $usuariosecre[0]->nombre.'-'.$usuariosecre[0]->apellidopaterno.'-'.$usuariosecre[0]->apellidomaterno }} </label></h3>
              <div class="row">
                      <div class="col">
  ...
  var formattedDate = currentDate.toISOString().slice(0, 10);
   ...
   pdfMake.createPdf(docDefinition).download(
     "reporte_promedio_alumnos-" + formattedDate + ".pdf"
   );
  }
