    ...
    <table id="tabla" class="table align-items-center table-flush" >
      <thead class="thead-light">
        <tr>
          ...
          <th scope="col" data-column="apellidopaterno" class="sortable">apellidop aterno</th>
...
var formattedDate = currentDate.toISOString().slice(0, 10);
   ...
   content: [
      ...
      },
     {
       table: {
         ...
         headers: ['Fecha de ingreso', 'ci', 'nombre', 'apellido paterno','apellido materno','celular','direccion','correo','estado','imagen'],
 ...
 pdfMake.createPdf(docDefinition).download(
   "reporte_lista_alumnos-" + formattedDate + ".pdf"
 );
}
...
function obtenerDatosTabla() {
 ...
 var filas = [];
 var headers= [ 'Fecha de ingreso', 'ci', 'nombre', 'apellido paterno','apellido materno','celular','direccion','correo','estado','imagen'];
 filas.push(headers);
 profesorreporte.forEach(function (alumno) {
   var fila = [
    // profesor.id,
