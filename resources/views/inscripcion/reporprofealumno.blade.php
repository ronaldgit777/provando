...
var formattedDate = currentDate.toISOString().slice(0, 10);
   ...
   content: [
      ...
      },
     {
       table: {
         ...
         headers: [ 'fecha de inscripcion','	profesor','materia','costo','	periodo ','aula','alumno','apellido paterno','apellido materno','estado'],
 ...
 pdfMake.createPdf(docDefinition).download(
   "reporte_inscripioens_de_profesores-" + formattedDate + ".pdf"
 );
}
...
function obtenerDatosTabla() {
 ...
 var filas = [];
 var headers= [ 'fecha de inscripcion','	profesor','materia','costo','	periodo','aula','alumno','apellido paterno','apellido materno','estado'];
 filas.push(headers);
