                ...
                <div class="row align-items-center">
                    ...
                    <div  class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            @if(isset($asignarpromas) && count($asignarpromas) > 0)
                                ...
                                @else
            <tr>
            <td colspan="12">No hay asignaciones disponibles.</td>
            </tr>
            @endif
                            </tbody>
                        </table>
...
var formattedDate = currentDate.toISOString().slice(0, 10);
   ...
   content: [
      ...
      },
     {
       table: {
         ...
         headers: [ 'fecha de asignacion','	profesor','materia','costo','	aula','periodo','estado'],
 ...
 pdfMake.createPdf(docDefinition).download(
   "reporte_asignaciones_profesor-" + formattedDate + ".pdf"
 );
}
...
function obtenerDatosTabla() {
 ...
 var filas = [];
 var headers= [ 'fecha de asignacion','	profesor','materia','costo','	aula','periodo','estado'];
 filas.push(headers);
